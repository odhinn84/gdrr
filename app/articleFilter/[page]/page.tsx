...
import { findArticlesByPage, getTotalCount, setArticleSelected } from "@/lib/api/gameArticle/functions";
...
export default function ArticleFilter() {
    ...
    const [curMenu, setCurMenu] = useState("전체 기사 보기");
    ...
    useEffect(() => {
        const init = async () => {
            try {
                const resFindArticles = await findArticlesByPage(pageIdx, pageSize);
                ...
                const resArticlesCount = await getTotalCount();
    ...
    return (
        <div className="w-full flex justify-center">
            <div className="container flex flex-col gap-4 mb-20">
                ...
                <div className="divider"></div>
                {pageLoaded ? (<Pagination pageIdx={pageIdx}
                    pageStart={pageStart}
                    pageEnd={pageEnd}
                    totalPage={totalPage}
                />) : (
